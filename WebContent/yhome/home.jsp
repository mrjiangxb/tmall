									...
									<div class="category">
										<ul class="category-list" id="js_climit_li">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="images/cookies.png"></i><a class="ml-22" title="饼干、膨化">电脑</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="images/meat.png"></i><a class="ml-22" title="熟食、肉类">配件</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="images/bamboo.png"></i><a class="ml-22" title="素食、卤味">电器</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="images/nut.png"></i><a class="ml-22" title="坚果、炒货">书籍</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="images/candy.png"></i><a class="ml-22" title="糖果、蜜饯">娱乐</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="images/chocolate.png"></i><a class="ml-22" title="巧克力">运动</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="images/fish.png"></i><a class="ml-22" title="海味、河鲜">零食</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="images/tea.png"></i><a class="ml-22" title="花茶、果茶">衣饰</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative last">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="images/package.png"></i><a class="ml-22" title="品牌、礼包">美妆</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
				...
				<div class="shopMain" id="shopmain">
					...
					<div class="am-g am-g-fixed floodFive ">
						...
						<div class="am-u-sm-5 am-u-md-3 text-one list">
							<div class="word">
								<a class="outer" href="#"><span class="inner"><b class="text">小说</b></span></a>
								<a class="outer" href="#"><span class="inner"><b class="text">文学</b></span></a>
								<a class="outer" href="#"><span class="inner"><b class="text">传记</b></span></a>	
								<a class="outer" href="#"><span class="inner"><b class="text">艺术</b></span></a>
								<a class="outer" href="#"><span class="inner"><b class="text">管理</b></span></a>
								<a class="outer" href="#"><span class="inner"><b class="text">生活</b></span></a>									
							</div>						
							<a href="# ">
								<img src="images/书籍1.jpg " />
								<div class="outer-con ">
									<div class="title ">
...
<i class="am-icon-shopping-basket am-icon-md  seprate"></i>								
							...
							<a href="# "><img src="images/嫌疑人1.jpg" /></a>
						</div>			
...
<i class="am-icon-shopping-basket am-icon-md  seprate"></i>								
							...
							<a href="# "><img src="images/霍乱1.jpg" /></a>
						</div>	
...
<i class="am-icon-shopping-basket am-icon-md  seprate"></i>								
							...
							<a href="# "><img src="images/书1.jpg" /></a>
						</div>	
...
<i class="am-icon-shopping-basket am-icon-md  seprate"></i>								
							...
							<a href="# "><img src="images/白鹿原1.jpg" /></a>
						</div>							
					</div>
					...
					<div class="am-g am-g-fixed floodFour">
						<div class="am-u-sm-5 am-u-md-4 text-one list ">
							<div class="word">
								<a class="outer" href="#"><span class="inner"><b class="text">运动服</b></span></a>
								<a class="outer" href="#"><span class="inner"><b class="text">运动鞋</b></span></a>
								<a class="outer" href="#"><span class="inner"><b class="text">户外装备</b></span></a>	
								<a class="outer" href="#"><span class="inner"><b class="text">汽摩配件</b></span></a>
								<a class="outer" href="#"><span class="inner"><b class="text">运动用品</b></span></a>
								<a class="outer" href="#"><span class="inner"><b class="text">健身器</b></span></a>									
							</div>
							<a href="# ">
								<div class="outer-con ">
									<div class="title ">
...
<i class="am-icon-shopping-basket am-icon-md  seprate"></i>									
								...
								<a href="# "><img src="images/羽毛球2.JPG" /></a>
							</div>
...
<i class="am-icon-shopping-basket am-icon-md  seprate"></i>									
								...
								<a href="# "><img src="images/篮球1.jpg" /></a>
							</div>
...
<i class="am-icon-shopping-basket am-icon-md  seprate"></i>								
							...
							<a href="# "><img src="images/跑步机1.jpg" /></a>
						</div>
...
<i class="am-icon-shopping-basket am-icon-md  seprate"></i>								
							...
							<a href="# "><img src="images/自行车1.jpg" /></a>
						</div>
...
<i class="am-icon-shopping-basket am-icon-md  seprate"></i>								
							...
							<a href="# "><img src="images/乒乓1.jpg" /></a>
						</div>
...
<i class="am-icon-shopping-basket am-icon-md  seprate"></i>								
							...
							<a href="# "><img src="images/电动车1.jpg" /></a>
						</div>
                 ...
                 <div class="clear "></div>                 
					...
					<div class="am-g am-g-fixed floodFive ">
						...
						<div class="am-u-sm-5 am-u-md-3 text-one list">
							<div class="word">
								<a class="outer" href="#"><span class="inner"><b class="text">衣服</b></span></a>
								<a class="outer" href="#"><span class="inner"><b class="text">手饰</b></span></a>
								<a class="outer" href="#"><span class="inner"><b class="text">项链</b></span></a>	
								<a class="outer" href="#"><span class="inner"><b class="text">耳环</b></span></a>
								<a class="outer" href="#"><span class="inner"><b class="text">帽子</b></span></a>
								<a class="outer" href="#"><span class="inner"><b class="text">包包</b></span></a>									
							</div>						
							<a href="# ">
								<img src="images/衣饰1.jpg " />
								<div class="outer-con ">
									<div class="title ">
...
<i class="am-icon-shopping-basket am-icon-md  seprate"></i>									
								...
								<a href="# "><img src="images/裙子1.jpg " /></a>						
						</div>
...
<i class="am-icon-shopping-basket am-icon-md  seprate"></i>								
							...
							<a href="# "><img src="images/帽子1.jpg" /></a>
						</div>
						<div class="am-u-md-2 am-u-lg-2 text-three big">
							<div class="outer-con ">
								<div class="title ">
...
<i class="am-icon-shopping-basket am-icon-md  seprate"></i>								
							...
							<a href="# "><img src="images/手链1.jpg" /></a>
						</div>			
						<div class="am-u-sm-4 am-u-md-5 am-u-lg-4 text-five">
							<div class="outer-con ">
								<div class="title ">
...
<i class="am-icon-shopping-basket am-icon-md  seprate"></i>								
							...
							<a href="# "><img src="images/短袖1.jpg" /></a>
						</div>	
						<div class="am-u-sm-4 am-u-md-2 am-u-lg-2 text-six">
							<div class="outer-con ">
								<div class="title ">
...
<i class="am-icon-shopping-basket am-icon-md  seprate"></i>								
							...
							<a href="# "><img src="images/耳环1.jpg" /></a>
						</div>	
						<div class="am-u-sm-4 am-u-md-2 am-u-lg-4 text-six big">
							<div class="outer-con ">
								<div class="title ">
...
<i class="am-icon-shopping-basket am-icon-md  seprate"></i>								
							...
							<a href="# "><img src="images/耳环2.jpg" /></a>
						</div>							
					</div>
					<div class="clear "></div>
					</div>
